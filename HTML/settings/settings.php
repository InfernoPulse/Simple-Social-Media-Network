...
<body>
	...
	<div class = "grid-container" id = "gen">
		...
		<!--Feed-->
		<div class = "posts">
				<form action = "settingchange.php" method = "GET">
				<br><br><strong>Themes</strong><br><br>
					&nbsp&nbsp&nbsp&nbsp<input type = "radio" name = "theme" value = "light" checked>Light<br>
					&nbsp&nbsp&nbsp&nbsp<input type = "radio" name = "theme" value = "dark">Dark<br>
