	...
	<div class = "grid-container" id = "gen">
		...
		<div class = "posts"><br>
            <form action = "settingchangea.php" method = "POST">
                <br><strong>Change Your Username</strong><br><br>
                    &nbsp&nbsp&nbsp&nbsp<textarea name = "uname" rows="2" cols="60"></textarea>
                <br>
                <br><strong>Change Your Password</strong><br><br>
                &nbsp&nbsp&nbsp&nbsp<textarea name = "uname" rows="2" cols="60" placeholder = "Password"></textarea>
                <br>&nbsp&nbsp&nbsp&nbsp<textarea name = "uname" rows="2" cols="60" placeholder = "Re-enter Password"></textarea><br>
                <br>
